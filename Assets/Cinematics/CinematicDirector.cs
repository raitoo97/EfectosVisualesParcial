...
public class CinematicDirector : MonoBehaviour
{
    ...
    {
        _firstCinematic = new FirstCinematic(_waterDrop.transform, this, _bossAnimator, _soldiersAnimator, _soldiers, doorBossRef);
    ...
    {
        _firstCinematic.CloseDoorBoss();
    }
    public void OpenOtherDoorDoorBoss()
    {
        _firstCinematic.CloseDoorBoss();
    }
    #endregion
